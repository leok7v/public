 ...
 * Iterable}, varargs or even a {@link java.util.Map}) with a separator. It either
...
public class Joiner {
   ...
   * Object, Object[]), except that it does not throw {@link java.io.IOException}.
   */
  ...
  public MapJoiner withKeyValueSeparator(String keyValueSeparator) {
    return new MapJoiner(this, Preconditions.checkNotNull(keyValueSeparator));
  }
  ...
  public static class MapJoiner {
     ...
     * Appends the string representation of each entry of {@code map}, using the
     * previously configured separator and key-value separator, to {@code
     * builder}. Identical to {@link #appendTo(Appendable, java.util.Map)}, except that it
     * does not throw {@link java.io.IOException}.
     */
